...
type StarFunc func(context.Context, *ent.StarMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f StarFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.StarMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.StarMutation", m)
}
...
// The VoteEventFunc type is an adapter to allow the use of ordinary
// function as VoteEvent mutator.
type VoteEventFunc func(context.Context, *ent.VoteEventMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VoteEventFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VoteEventMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VoteEventMutation", m)
}

// The VoteOptionFunc type is an adapter to allow the use of ordinary
// function as VoteOption mutator.
type VoteOptionFunc func(context.Context, *ent.VoteOptionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VoteOptionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VoteOptionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VoteOptionMutation", m)
}
