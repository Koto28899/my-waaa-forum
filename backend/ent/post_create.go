...
func (pc *PostCreate) SetFromRoleID(i int64) *PostCreate {
	pc.mutation.SetFromRoleID(i)
	return pc
}

// SetToSectionID sets the "to_section_id" field.
func (pc *PostCreate) SetToSectionID(i int64) *PostCreate {
	pc.mutation.SetToSectionID(i)
	return pc
}

// SetLikesCount sets the "likes_count" field.
func (pc *PostCreate) SetLikesCount(i int64) *PostCreate {
	pc.mutation.SetLikesCount(i)
	return pc
}

// SetNillableLikesCount sets the "likes_count" field if the given value is not nil.
func (pc *PostCreate) SetNillableLikesCount(i *int64) *PostCreate {
	if i != nil {
		pc.SetLikesCount(*i)
	}
	return pc
...
func (pc *PostCreate) SetIsTop(b bool) *PostCreate {
	pc.mutation.SetIsTop(b)
	return pc
}

// SetNillableIsTop sets the "is_top" field if the given value is not nil.
func (pc *PostCreate) SetNillableIsTop(b *bool) *PostCreate {
	if b != nil {
		pc.SetIsTop(*b)
	}
	return pc
...
func (pc *PostCreate) SetIsHighlight(b bool) *PostCreate {
	pc.mutation.SetIsHighlight(b)
	return pc
}

// SetNillableIsHighlight sets the "is_highlight" field if the given value is not nil.
func (pc *PostCreate) SetNillableIsHighlight(b *bool) *PostCreate {
	if b != nil {
		pc.SetIsHighlight(*b)
	}
	return pc
...
func (pc *PostCreate) defaults() {
	...
	if _, ok := pc.mutation.IsTop(); !ok {
		v := post.DefaultIsTop
		pc.mutation.SetIsTop(v)
	}
	if _, ok := pc.mutation.IsHighlight(); !ok {
		v := post.DefaultIsHighlight
		pc.mutation.SetIsHighlight(v)
	}
}
...
func (pc *PostCreate) check() error {
	...
	if _, ok := pc.mutation.FromRoleID(); !ok {
		return &ValidationError{Name: "from_role_id", err: errors.New(`ent: missing required field "Post.from_role_id"`)}
	}
	if v, ok := pc.mutation.FromRoleID(); ok {
	...
	if _, ok := pc.mutation.ToSectionID(); !ok {
		return &ValidationError{Name: "to_section_id", err: errors.New(`ent: missing required field "Post.to_section_id"`)}
	}
	if v, ok := pc.mutation.ToSectionID(); ok {
	...
	if v, ok := pc.mutation.LikesCount(); ok {
	...
	if _, ok := pc.mutation.IsTop(); !ok {
		return &ValidationError{Name: "is_top", err: errors.New(`ent: missing required field "Post.is_top"`)}
	}
	if _, ok := pc.mutation.IsHighlight(); !ok {
		return &ValidationError{Name: "is_highlight", err: errors.New(`ent: missing required field "Post.is_highlight"`)}
	}
