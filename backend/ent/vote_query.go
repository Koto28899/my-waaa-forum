...
func (vq *VoteQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (vq *VoteQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(vote.Table, vote.Columns, sqlgraph.NewFieldSpec(vote.FieldID, field.TypeInt64))
	_spec.From = vq.sql
...
func (vq *VoteQuery) ForUpdate(opts ...sql.LockOption) *VoteQuery {
...
func (vq *VoteQuery) ForShare(opts ...sql.LockOption) *VoteQuery {
	if vq.driver.Dialect() == dialect.Postgres {
		vq.Unique(false)
	}
	vq.modifiers = append(vq.modifiers, func(s *sql.Selector) {
