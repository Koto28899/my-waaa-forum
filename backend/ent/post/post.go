...
const (
	...
	// FieldToSectionID holds the string denoting the to_section_id field in the database.
	FieldToSectionID = "to_section_id"
	...
	FieldIsTop = "is_top"
	// FieldIsHighlight holds the string denoting the is_highlight field in the database.
...
var (
	...
	// ToSectionIDValidator is a validator for the "to_section_id" field. It is called by the builders before save.
	ToSectionIDValidator func(int64) error
	...
	DefaultIsTop bool
	// DefaultIsHighlight holds the default value on creation for the "is_highlight" field.
	DefaultIsHighlight bool
...
// ByToSectionID orders the results by the to_section_id field.
func ByToSectionID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldToSectionID, opts...).ToFunc()
}
...
// ByIsHighlight orders the results by the is_highlight field.
func ByIsHighlight(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldIsHighlight, opts...).ToFunc()
}
