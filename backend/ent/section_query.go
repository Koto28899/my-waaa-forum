...
func (sq *SectionQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (sq *SectionQuery) FirstIDX(ctx context.Context) int64 {
...
func (sq *SectionQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (sq *SectionQuery) OnlyIDX(ctx context.Context) int64 {
...
func (sq *SectionQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (sq *SectionQuery) IDsX(ctx context.Context) []int64 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SectionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(section.Table, section.Columns, sqlgraph.NewFieldSpec(section.FieldID, field.TypeInt64))
	_spec.From = sq.sql
...
func (sq *SectionQuery) ForUpdate(opts ...sql.LockOption) *SectionQuery {
...
func (sq *SectionQuery) ForShare(opts ...sql.LockOption) *SectionQuery {
	if sq.driver.Dialect() == dialect.Postgres {
		sq.Unique(false)
	}
	sq.modifiers = append(sq.modifiers, func(s *sql.Selector) {
